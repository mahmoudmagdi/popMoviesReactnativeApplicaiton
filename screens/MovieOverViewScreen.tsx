...
function MovieOverViewScreen({ route, navigation }: MovieOverViewScreenProps): React.JSX.Element {
  ...
  switch (selectedFilter) {
    case "Popular":
      movieItem = movieCtx?.popularMovies.find(movie => movie.id === movieId) ?? null;
      break;
    case "Top Rated":
      movieItem = movieCtx?.topRatedMovies.find(movie => movie.id === movieId) ?? null;
      break;
    case "Now Playing":
      movieItem = movieCtx?.nowPlayingMovies.find(movie => movie.id === movieId) ?? null;
      break;
    case "Upcoming":
      movieItem = movieCtx?.upcomingMovies.find(movie => movie.id === movieId) ?? null;
      break;
    default:
      movieItem = null;
  }
    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.detailsContainer}>
          ...
          <MovieDetails customStyle={styles.movieDetails} movie={movieItem} direction="row" />
        </View>
      </ScrollView>
    </View>
  );
